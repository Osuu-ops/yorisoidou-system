...
def main() -> int:
    ...
    evidence = {
        ...
        "primary_workflow_run_url": wf_url,
        "phase": phase,
        "phase_status": (args.phase_status or "").strip(),
        "phase_result_local_path": phase_result_path,
        "phase_summary_local_path": phase_summary_path,
        "phase_pointers_local_path": phase_pointers_json,
        "restart_packet_local_path": restart_packet_path,
        ...
        "primary_phase_result_pointer": phase_result_pointer,
        "primary_phase_summary_pointer": phase_summary_pointer,
        "primary_phase_pointers_pointer": phase_pointers_pointer,
        "primary_restart_packet_pointer": restart_packet_pointer,
    ...
    rs["loop_state"] = {
        ...
        "phase_result_local_path": evidence["phase_result_path"],
        "phase_summary_local_path": evidence["phase_summary_path"],
        "phase_pointers_local_path": evidence["phase_pointers_json"],
        "restart_packet_local_path": evidence["restart_packet_path"],
        "reason_code": (args.reason_code or "").strip(),
