# SEALED_LEGACY_WORKFLOWS
Legacy/temporary workflow YAML contents are sealed by renaming to **.yml.txt** (non-executable by GitHub Actions).
Canonical SSOT workflow remains active (Q148/Q149):
- mep_writeback_bundle_dispatch_entry.yml (workflow id: 228815143)
Sealed files:
- mep_writeback_bundle_dispatch_entry_rereg.yml.txt
- mep_writeback_bundle_dispatch_manual.yml.txt
