...
SYSTEM は、以下の条件を満たす文書を対象として扱う。

- 拡張子：`.md`
- 配置：
  - `MEP_core/foundation/` 配下
  - `MEP_core/protocol/` 配下
...
SYSTEM は、  
当該注記を追加するための **unified diff** を生成して提示する。

- 自動適用は行わない
- 差分生成は **P フェーズの生成物**として扱う
