...
- 完全OS完成（A+B 完了）：SSOT_SCAN / CONFLICT_SCAN / EXTRACT / Self-heal完全 を統合し、post-writeback + loop owned phase resume と canonical engine run completion 追跡を含めて仕様本体までrunnerが責任を持つ
